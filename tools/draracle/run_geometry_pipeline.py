...
def main():
    ...
    steps=[('lol2_draracle_openings.py','geometry'),('lol2_verify_draracle_slopes.py','slopes'),('lol2_verify_draracle_connectors.py','connectors'),('lol2_extract_wall_records.py','walls'),('lol2_verify_flat_wall_spans.py','flat_walls')]
