...
def main():
    ...
    report=dict(props=props,count=len(props),scope='Original static placement/state dimensions and frame trims. Source resource routing flags0/2; flag2 region-height selection verified separately. Fixed-Y billboard, first frame, alpha and frame-flag orientation are preview assumptions; no spawn/interaction/collision parity. Original anchors preserved; no floor snapping.')
